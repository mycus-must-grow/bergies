...
# Read <list.deploy> as a buffer and iterate with each newline. See line #87.
while IFS= read -r line
do
  line=${line%/}

# Compare existing paths and see if they end up pointing to the same thing, if
# yes: they are sort of linked.
...
# Reads <list.deploy>'s content into our while loop. See line #48
done < "$list_to_deploy"
